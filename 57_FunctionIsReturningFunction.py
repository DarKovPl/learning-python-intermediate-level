...
rt = main_function(enter_date=input("Please enter here the date 'RRRR-MM-DD HH MM SS': "))
print(rt(units_of_time=input('Please chose which unit of date you want to work?\n{}\nEnter chosen value here-->'
